	...
	render() {
		return (
			<tr>
				...
				<td>{this.props.offer.salary} <FormattedPlural value={this.props.offer.salary} one={<FormattedMessage id="one" />} other={<FormattedMessage id="plural" />} /></td>
				...
				<td><FormattedNumber value={1900000} /></td>
			</tr>
		);
	}
}